...
<body>
	<div id="colorlib-page">
		...
		<aside id="colorlib-aside" role="complementary"
			...
			<p></p>
			<h1 id="colorlib-logo">
				<a href="/"><span>Wo</span><span>rk</span></a>
			</h1>
...
-->
			...
			<div id="login" class="login">
				<div class="login-icon-field">
					<svg class="login-icon" xmlns="http://www.w3.org/2000/svg"
						...
						y="0px" viewBox="5.0 -10.0 100.0 135.0"
        ...
        <g>
          ...
          <animateTransform id="spin" attributeName="transform"
							type="rotate" dur="2s" from="0 50 50" to="360 50 50"
							repeatCount=".4" fill="freeze" />
        </g>
      </svg>
				</div>
				<div class="login-form">
					<div class="username-row row">
						<label for="username_input"> <svg version="1.1"
								class="user-icon" x="0px" y="0px" viewBox="-255 347 100 100"
          ...
          C-191.3,356.5-196.9,350.3-203.7,350.3L-203.7,350.3z" />
						...
						</label> <input type="text" id="username_input" class="username-input"
							placeholder="Username"></input>
					</div>
					<div class="password-row row">
						<label for="password_input"> <svg version="1.1"
								class="password-icon" x="0px" y="0px" viewBox="-255 347 100 100"
          ...
          l1.6-6.7l7.1-0.3l0.6-7.2l7.2-6.6c2.8,1.3,5.8,2,9.1,2c11.9,0,21.6-9.7,21.6-21.6C-169.9,357.4-179.6,347.8-191.5,347.8z" />
						...
						</label> <input type="password" id="password_input" class="password-input"
							class="input" placeholder="Password"></input>
					</div>
				</div>
