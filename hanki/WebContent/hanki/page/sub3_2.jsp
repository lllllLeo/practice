...
<!--예약조회를 위한 이름, 번호입력페이지-->
	...
	<form action="ResCheckAction.yu" method="post" style='margin:0'>
		<div class="write">
			<fieldset>
				...
				<dl>
					<dt><label for="res_name">이름
					<dd> <span class="ui-input"><input type="text" name="res_name"></span> </dd></label></dt>
				</dl>
				<dl>
					<dt><label for="res_phone">휴대폰번호
					<dd> <span class="ui-input"><input type="text" name="res_phone"></span> </dd></label></dt>
                </dl>
			</fieldset>

			<div class="btngroup">
			<input type="submit" value="조회하기"  class="ui-btn btn-co1">
			<input type="reset" value="취소하기"  class="ui-btn">
<!-- 				<button type="button" onclick="submitForm()" class="ui-btn btn-co1">조회하기</button> -->
...
function submitForm(){
    ...
    if(frm.res_name.value==""){
    	alert('예약자 이름을 입력해주세요');
    }
/*  	// 이름
    if (!checkNull(frm.res_name, "예약자이름을 입력하세요", true)) return;

 	// 휴대폰번호
 	if (!checkNull(frm.res_phone, "휴대폰번호를 선택해주세요", true)) return;
 	 */
 	frm.submit();
   </script>
