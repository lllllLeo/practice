...
<html>
<!-- Mirrored from www.hankikor.com/shop_info/agree.htm by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 08 May 2018 09:28:52 GMT -->
<!-- Added by HTTrack --><meta http-equiv="content-type" content="text/html;charset=utf-8" /><!-- /Added by HTTrack -->
<head>
<meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
<title>(주)쉐프마인드 이용약관</title>
...
<meta name="subject" content="(주)쉐프마인드 이용약관" />
<meta name="copyright" content="(주)쉐프마인드" />
<meta name="title" content="(주)쉐프마인드 이용약관" />
<meta name="description" content="패밀리 퓨전레스토랑 프랜차이즈, 브랜드스토리, 메뉴소개 및 매장안내, 매장창업" />
<link rel="canonical" href="agree.html" />
<meta property="og:title"           content="(주)쉐프마인드 이용약관"/>
<meta property="og:site_name"       content="(주)쉐프마인드"/>
<meta property="og:type"            content="website"/>
<meta property="og:url"             content="agree.jsp"/>
...
<meta name="twitter:title"          content="(주)쉐프마인드 이용약관">
...
<link rel="stylesheet" type="text/css" href="../img_up/shop_pds/ehompy0118/src_css/farm_design_a_mobile.css" />
<link rel="stylesheet" type="text/css" href="../img_up/shop_pds/ehompy0118/src_css/farm_design_a_tablet.css" media="only all and (min-width:768px)"/>
<link rel="stylesheet" type="text/css" href="../img_up/shop_pds/ehompy0118/src_css/farm_design_a_pc.css" media="only all and (min-width:1024px)"/>
<!--[if lt IE 9]> <link rel="stylesheet" type="text/css" href="/img_up/shop_pds/ehompy0118/src_css/farm_design_a_tablet.css" /> <![endif]-->
<!--[if lt IE 9]> <link rel="stylesheet" type="text/css" href="/img_up/shop_pds/ehompy0118/src_css/farm_design_a_pc.css" /> <![endif]-->
...
<script type="text/javascript" src="../img_up/_addon/_plugin/modernizr/modernizr.custom.media.query.js"></script>
	...
	var page_title = "(주)쉐프마인드 이용약관";
			...
			var ai_log_page_title = "(주)쉐프마인드 이용약관"; // 페이지 제목
			...
			var ai_log_event_sale_price = ""; // ai_log_event_mode가 sale 일때  매출 금액
				...
				<script type="text/javascript" id="ai_log_default_script" src="http://chk101.ai-log.biz/etc/connect_ai_set68b3.js?ver=1"></script>
							</head>
...
<div id="snb_57715_" class="snb_57715_">
	...
	<ul class="dep1">
					<li>
				<a href="privacy.jsp">개인정보취급방침</a>
							</li>					<li>
				<a href="agree.jsp">이용약관</a>
							</li>			</ul>
	<!-- // 1 Depth -->
</div>
...
<div   style='margin-top:-5px;margin-bottom:-10px;'  ><!-- ---------------    body content : 57359 --------------- -->
...
<div class="farm-A-agreement">
	<div class="farm-A-bd">
		<script type="text/javascript" src="../img_up/_addon/_styles/agree/gototop.js"></script>
<link rel="stylesheet" type="text/css" href="../img_up/_addon/_styles/agree/agree.css" media="screen">
<div class="agreementBody">
	...
	<div class="hgrp">
		...
		<h5>공정거래위원회 표준약관 제10023호</h5>
		<h3>인터넷 사이버몰 利用標準約款</h3>
	</div>
	<div class="acon">
		<h4>제1조(목적)</h4>
		<p>
			이 약관은 (주)쉐프마인드 회사(전자상거래 사업자)가 운영하는 (주)쉐프마인드 사이버 몰(이하 “몰”이라 한다)에서 제공하는 인터넷 관련 서비스(이하 “서비스”라 한다)를 이용함에 있어 사이버 몰과 이용자의 권리,의무 및 책임사항을 규정함을 목적으로 합니다.<br/>
			※「PC통신, 무선 등을 이용하는 전자상거래에 대해서도 그 성질에 반하지 않는 한 이 약관을 준용합니다」
		</p>
		<p class="sc_ptop"><a href="#top">TOP</a></p>
	</div>
	<div class="acon">
		<h4>제2조(정의)</h4>
		<ol>
			<li>“몰” 이란 (주)쉐프마인드 회사가 재화 또는 용역(이하 “재화등”이라 함)을 이용자에게 제공하기 위하여 컴퓨터등 정보통신설비를 이용하여 재화등을 거래할 수 있도록 설정한 가상의 영업장을 말하며, 아울러 사이버몰을 운영하는 사업자의 의미로도 사용합니다.</li>
	...
	<div class="acon">
		...
		<ol>
			<li>“몰”은 이 약관의 내용과 상호 및 대표자 성명, 영업소 소재지 주소(소비자의 불만을 처리할 수 있는 곳의 주소를 포함), 전화번호?모사전송번호?전자우편주소, 사업자등록번호, 통신판매업신고번호, 개인정보관리책임자등을 이용자가 쉽게 알 수 있도록 00 사이버몰의 초기 서비스화면(전면)에 게시합니다. 다만, 약관의 내용은 이용자가 연결화면을 통하여 볼 수 있도록 할 수 있습니다.</li>
			...
			<li>“몰”은 전자상거래등에서의 소비자보호에관한법률, 약관의규제에관한법률, 전자거래기본법, 전자서명법, 정보통신망이용촉진등에관한법률, 방문판매등에관한법률, 소비자보호법 등 관련법을 위배하지 않는 범위에서 이 약관을 개정할 수 있습니다.</li>
			<li>“몰”이 약관을 개정할 경우에는 적용일자 및 개정사유를 명시하여 현행약관과 함께 몰의 초기화면에 그 적용일자 7일이전부터 적용일자 전일까지 공지합니다.<br>
	...
	<div class="acon">
		...
		<ol>
			...
			<li>사업종목의 전환, 사업의 포기, 업체간의 통합 등의 이유로 서비스를 제공할 수 없게 되는 경우에는 “몰”은 제8조에 정한 방법으로 이용자에게 통지하고 당초 “몰”에서 제시한 조건에 따라 소비자에게 보상합니다. 다만, “몰”이 보상기준 등을 고지하지 아니한 경우에는 이용자들의 마일리지 또는 e-Money 등을 “몰”에서 통용되는 통화가치에 상응하는 현물 또는 현금으로 이용자에게 지급합니다.</li>
		</ol>
		<p class="sc_ptop"><a href="#top">TOP</a></p>
	</div>
	<div class="acon">
	...
	<div class="acon">
		...
		<ol>
			...
			<li>
				...
				<ol>
					<li>가입신청시에 허위내용을 등록한 경우</li>
					<li>“몰”을 이용하여 구입한 재화등의 대금, 기타 “몰”이용에 관련하여 회원이 부담하는 채무를 기일에 지급하지 않는 경우</li>
					<li>다른사람의 “몰” 이용을 방해하거나 그 정보를 도용하는 등 전자상거래 질서를 위협하는 경우</li>
	...
	<div class="acon">
		<h4>제14조(환급)</h4>
		<div>
			“몰”은 이용자가 구매신청한 재화등이 품절 등의 사유로 인도 또는 제공을 할 수 없을 때에는 지체없이 그 사유를 이용자에게 통지하고 사전에 재화 등의 대금을 받은 경우에는 대금을 받은 날부터 2영업일 이내에 환급하거나 환급에 필요한 조치를 취합니다.</div>
		<p class="sc_ptop"><a href="#top">TOP</a></p>
	</div>
	<div class="acon">
		<h4>제15조(청약철회 등)</h4>
	...
	<div class="acon">
		...
		<ol>
			<li>
				...
				<ol>
					<li>성명</li>
					<li>주민등록번호(회원의 경우) 또는 외국인등록번호</li>
					<li>주소</li>
					<li>전화번호</li>
					<li>희망ID(회원의 경우)</li>
					<li>비밀번호(회원의 경우)</li>
	...
	<div class="acon">
		...
		<div>
			...
			<ol>
				...
				<li>외설또는 폭력적인 메시지, 화상, 음성, 기타 공서양속에 반하는 정보를 몰에 공개 또는 게시하는 행위</li>
			</ol>
		</div>
		<p class="sc_ptop"><a href="#top">TOP</a></p>
	</div>
