...
<meta name="subject" content="(주)쉐프마인드 자유게시판" />
<meta name="copyright" content="(주)쉐프마인드" />
<meta name="title" content="(주)쉐프마인드 자유게시판" />
<meta name="description" content="패밀리 퓨전레스토랑 프랜차이즈, 브랜드스토리, 메뉴소개 및 매장안내, 매장창업" />
<link rel="canonical" href="http://www.hankikor.com/bbs/g1" />
<meta property="og:title"           content="(주)쉐프마인드 자유게시판"/>
<meta property="og:site_name"       content="(주)쉐프마인드"/>
<meta property="og:type"            content="website"/>
<meta property="og:url"             content="http://www.hankikor.com/bbs/g1"/>
...
<meta name="twitter:title"          content="(주)쉐프마인드 자유게시판">
...
<!--[if lt IE 8]><link rel="stylesheet" type="text/css" href="/img_up/tmp_img/service/board_tpl/8/pc/css/ie7.css" media="all"><![endif]-->
   ...
   var page_title = "(주)쉐프마인드 자유게시판";
         ...
         var ai_log_page_title = "(주)쉐프마인드 자유게시판"; // 페이지 제목
         var ai_log_page_url = "/bbs/g1"; // 페이지 url, 빈값 입력시 브라우져 url 자동 입력 입니다.
...
<div class="logo_183743_">
   <h1><a href="../main.yu" target="_self"><img src="./hanki/img_up/shop_pds/ehompy0118/farm/logo15196106291.jpg" alt="로고"></a></h1>
...
<div id="scbd" class="scbd co-basic">
   ...
   <div id="lay_hd" class="lay_hd">
      <div class="hgroup">
         <h1><a href="./hanki/bbs_shop/list.htm?me_popup=&auto_frame=&cate_sub_idx=0&list_mode=board&board_code=g1&keyfield=&key=&page=&y=&m=">자유게시판</a></h1>
         <ul>
            <!-- <li>
            ...
            <li>
               ...
               <!-- <a href="./board/write_form.jsp">글쓰기<i class="ui-ico write"></i></a> -->
            </li>         </ul>
      </div>
      <div id="toggleSearch" class="toggleSearch">
         <form name='search_form' method='get' action='./hanki/bbs_shop/list.htm'>
            <input type='hidden' name='list_mode' value='board'>
            <input type='hidden' name='cate_sub_idx' value='0'>
            <input type='hidden' name='board_code' value='g1'>
   ...
   <div id="list_board" class="list_board">
      ...
      <ul class="lst-board lst-body">
         <li class="clr">
<!-- 글번호 --> <div class="td col_no"><%=bl.getBOARD_NUM()%></div>
            <div class="td col_subject">
            <div style="padding-left:0px;">
               <a href="./BoardDetailAction.bo?num=<%=bl.getBOARD_NUM()%>">
                        <span><%=bl.getBOARD_SUBJECT()%></span></a>
            </div>
            </div>
            <div class="td inf col_name"><%=bl.getBOARD_NAME() %></div>
            <div class="td inf col_date"><%=bl.getBOARD_DATE() %></div>
            <div class="td inf col_hit"><span class="txt">조회수:</span><%=bl.getBOARD_READCOUNT() %></div>
         </li>
         <%}%>
<!--          <li class="clr">
글번호   <div class="td col_no">3</div>   
               <div class="td col_subject">
                  <div style="padding-left:0px;">
                     <a href="Javascript:secret_read2('275252')">
글제목               <span>인테리어 제휴제안드립니다.</span>
비밀글아이콘         <img src="/img_up/tmp_img/service/board_tpl/8/pc/img/ico_secret.png" height="12" alt="secret">                                          
파일아이콘         <img src="/img_up/tmp_img/service/board_tpl/8/pc/img/ico_file.png" height="12" alt="file"></a>
                  </div>
               </div>
작성자      <div class="td inf col_name">선경</div>
작성날짜   <div class="td inf col_date">2018-03-07</div>
조회수      <div class="td inf col_hit"><span class="txt">조회수:</span>7</div>
                                 
         </li><li class="clr">
            <div class="td col_no">2</div>
               <div class="td col_subject">
                  <div style="padding-left:0px;">
                     <a href="/bbs_shop/read.htm?me_popup=&auto_frame=&cate_sub_idx=0&list_mode=board&board_code=g1&search_key=&key=&page=&idx=269812"></a>
                        <span>여기 맛있어요!</span>
                     <span class="cmt">[1]</span>
                  </div>
               </div>
            <div class="td inf col_name">최순원</div>
            <div class="td inf col_date">2017-11-21</div>
            <div class="td inf col_hit"><span class="txt">조회수:</span>251</div>                     
         </li><li class="clr">
            <div class="td col_no">1</div>
               <div class="td col_subject">
                  <div style="padding-left:15px;">
                     <a href="Javascript:reply_readArticle('270012')">
                        <span class="ui-ico reply" title="reply"></span>
                        <span>여기 맛있어요!</span></a>
                     </div>
                  </div>
               <div class="td inf col_name">한끼맛있다</div>
            <div class="td inf col_date">2017-11-24</div>
         <div class="td inf col_hit"><span class="txt">조회수:</span>79</div>                     </li>      </ul>
      </div> -->
   <!-- pagenate -->
 <!--   	<div class="paginate">
		<strong>1</strong>
		<a href="../bbs_shop/list.htm?page=2&board_code=hh1">2</a>
		<a href="../bbs_shop/list.htm?page=3&board_code=hh1">3</a>
		<a href="../bbs_shop/list.htm?page=2&board_code=hh1" class="dir" title="다음"><span>›</span></a>
	</div> -->
   <div class="paginate">
         <%if(nowpage<=1){ %>
          이전&nbsp;
         <%}else{ %>
          <a href="./BoardList.bo?page=<%=nowpage-1 %>"class="dir">이전</a>&nbsp;
         <%} %>
         <%for(int a=startpage;a<=endpage;a++){
            if(a==nowpage){%>
           <strong> <%=a %></strong>
            <%}else{ %>
            <a href="./BoardList.bo?page=<%=a %>" class="dir"><%=a %></a>&nbsp;
            <%} %>
         <%} %>
         <%if(nowpage>=maxpage){ %>
          다음
         <%}else{ %>
         <a href="./BoardList.bo?page=<%=nowpage+1 %>" class="dir">다음</a>
         <%} %>                  
                              </div>   <!-- // pagenate -->
</div></div></div></div>
   </div>
...
<nav class="fnb_57720_">
   <ul>
               <li><a href="./hanki/shop_info/privacy.htm">개인정보취급방침</a></li>
               <li><a href="./hanki/shop_info/agree.htm">이용약관</a></li>
               <li><a href="./hanki/page/sub1_3" target="_self">한끼맛있다 소개</a></li>
               <li><a href="./hanki/page/sub2_6" target="_self">개설절차</a></li>
               <li><a href="./hanki/myboard/cp368638" target="_self">매장찾기</a></li>
               <li><a href="./hanki/page/sub1_4" target="_self">오시는길</a></li>
               <li><a href="./hanki/page/sub2_1" target="_self">MENU</a></li>
         </ul>
   </nav>
</div></div>
   </div>
...
function replyArticle(idx){
                  location.href="/hanki/bbs_shop/reply_form.htm?me_popup=&auto_frame=&cate_sub_idx=0&list_mode=board&board_code=g1&keyfield=&key=&page=&idx="+idx; 
}
...
function comment_go(t_iframe,idx){
   t_iframe.location.href="/hanki/bbs_shop/comment_list.htm?me_popup=&auto_frame=&cate_sub_idx=0&board_code=g1&board_idx="+idx;
}
</script>
...
function blog_file_download(board_idx,sel_no){
   ...
   document.getElementById(iframe_name).src = '/hanki/bbs_shop/file_download.php?board_code=g1&board_idx='+board_idx+'&sel_no='+sel_no;
}
...
function tab_open2(no){
   obj_arr = new Array();
   obj_arr[0] = document.getElementById("tab_content_4");
obj_arr[1] = document.getElementById("tab_content_3");
obj_arr[2] = document.getElementById("tab_content_2");
obj_arr[3] = document.getElementById("tab_content_1");
;
...
function blog_view_Poll(board_idx){
   location.href='/bbs_shop/read.htm?board_code=g1&idx='+board_idx+'&poll_view=1';
}
...
function blog_vote_Poll(board_idx,poll_idx){
   ...
   if(!poll_sel){
      ...
      location.replace('/bbs_shop/read.htm?board_code=g1&idx='+board_idx+'&poll_idx='+poll_idx+'&poll_sel='+poll_sel)
   }
}
...
function blog_board_chu_ok(idx){
   if(confirm("추천 하시겠습니까?")){
      var iframe_name = create_iframe();
      document.getElementById(iframe_name).src='/bbs_shop/read_chu_ok.php?board_code=g1&idx='+idx;
   }
}
...
/*          location.href="/bbs_shop/write_form.htm?me_popup=0&auto_frame=&cate_sub_idx=0&list_mode=board&mode=write&board_code=g1"; */
   }
function readArticle(idx){

         location.href="./hanki/bbs_shop/read.htm?me_popup=0&auto_frame=&cate_sub_idx=0&list_mode=board&board_code=g1&search_key=&key=&page=1&y=&m=&idx="+idx;
   }
function reply_readArticle(idx){
         location.href="./hanki/bbs_shop/read.htm?me_popup=0&auto_frame=&cate_sub_idx=0&list_mode=board&board_code=g1&search_key=&key=&page=1&idx="+idx;
   }
...
function secret_read2(idx){
         var secret_read2_win = window.open('/bbs_shop/popup/pwd_chk_form.htm?pwd_mode=board_secret&me_popup=0&auto_frame=&cate_sub_idx=0&list_mode=board&board_code=g1&search_key=&key=&page=1&idx='+idx,'secret_read2_win','top=150,left=300,width=330,height=200,scrollbars=no');
...
<script type="text/javascript" src="./hanki/img_up/tmp_img/service/board_tpl/8/pc/js/default.js"></script>
