   ...
   <form name="frmWrite" action ="./BoardAddAction.bo"  enctype="multipart/form-data"  method="post" style='margin:0'>
         ...
         <fieldset>
            ...
            <dl>
               ...
               <dd><span class="ui-input"><input type="text" name="BOARD_NAME" value="" size="15"></span></dd>
            </dl>
            <dl>
            ...
            <dl>
               ...
               <dd><span class="ui-input ipt-block"><input type="text" name="BOARD_SUBJECT" value=""></span></dd>
            </dl>
            <dl>
             ...
             <textarea name='BOARD_CONTENT' id='BOARD_CONTENT' STYLE='width:100%;height:490px' title='본문내용' ></TEXTAREA>
