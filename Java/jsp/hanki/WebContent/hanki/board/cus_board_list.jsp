...
<meta name="subject" content="(주)쉐프마인드 문의게시판" />
<meta name="copyright" content="(주)쉐프마인드" />
<meta name="title" content="(주)쉐프마인드 문의게시판" />
...
<meta property="og:title"           content="(주)쉐프마인드 문의게시판"/>
...
<meta name="twitter:title"          content="(주)쉐프마인드 문의게시판">
...
<div class="logo_183743_">
   <h1><a href="./page/admin.ad" target="_self"><img src="./img_up/shop_pds/ehompy0118/farm/logo15196106291.jpg" alt="로고"></a></h1>
...
<div id="farmBoxLnb" class="lnb_183742_">
   ...
   <ul class="dep1">
         ...
         <div>
            ...
            <ul class="dep2">
                                             <li>
                  <a href="./page/sub2_6.yu" target="_self">매장별 현황</a>
               </li>
                                             <li>
                  <a href="./page/sub2_7.yu" target="_self">일자별 현황</a>
               </li>
        ...
        <%if(store_name.equals("전국점포")){%>
              ...
              <li class=" has_sub">
     		 <a href="./page/adminLogin.ad" target="_self">로그아웃</a>
         <div>
            <!-- // 2 Depth -->
             </div>      </li>
         </ul>
...
<div id="snb_57715_" class="snb_57715_">
   ...
   <ul class="dep1">
               <li>
            <a href="/bbs/g1" target="_self">공지/뉴스 관리</a><!-- 아직 -->
                     </li>	<li>
            <a href="./BoardList.bo" target="_self">자유게시판 관리</a>
                     </li>	<li class="on">
			<a href="./QnaListAction.yu" target="_self">1:1 문의 게시판</a>
...
<div class="img_ratio_58593_">
         <img src="./thum_img/ehompy0118/farm/qna.jpg" alt="qna">
   </div>
</div></div>
   </div>
</div>
...
<div id="scbd" class="scbd co-basic">
   ...
   <div id="lay_hd" class="lay_hd">
      <div class="hgroup">
         <h1><a href="./bbs_shop/list.htm?me_popup=&auto_frame=&cate_sub_idx=0&list_mode=board&board_code=g1&keyfield=&key=&page=&y=&m=">문의게시판</a></h1>
         <ul>
   ...
   <div id="list_board" class="list_board">
      ...
      <ul class="lst-board lst-body">
         <li class="clr">
<!-- 글번호 --> <div class="td col_no"><%=bl.getQ_num()%></div>
            <div class="td col_subject">
            <div style="padding-left:0px;">
               <a href="../BoardDetailAction.bo?num=<%=bl.getQ_num()%>">
                        <span><%=bl.getQ_title()%></span></a>
            </div>
            </div>
            <div class="td inf col_name"><%=bl.getQ_name() %></div>
            <div class="td inf col_date"><%=bl.getQ_location() %></div>
         </li>
         </ul>
         <%}%>
