...
<div class="img_ratio_58593_">
			<img src="../thum_img/ehompy0118/farm/reserve.jpg" alt="디너세트">
	</div>
</div></div>
	</div>
</div>
...
<script>
	function button_event(){
	    if(confirm("예약을 취소하시겠습니까?")==true){
		    location.href="ResCancelAction.yu?res_name=<%=reserbean.getRes_name()%>";
	    }else{
	        return;
	    }
	}
<%-- 	function button_event2(){
	    if(confirm("예약을 수정하시겠습니까?")==true){
		    location.href="ResModifyViewAction.yu?res_name=<%=reserbean.getRes_name()%>";
	    }else{
	        return;
	    }
	} --%>
	...
	<form name="ResCheckAction.yu" method="post" style='margin:0'>
		<div class="write">
			<fieldset>
				...
				<dl>
					<dt>
						<label for="store_code">지점</label>
							<dd>
								<span class="ui-input"><%=reserbean.getStore_code()%></span>
						   </dd>
					</dt>
				</dl>
				<dl>
					...
					<label for="res_name">이름</label>
						<dd>
							<span class="ui-input"><%=reserbean.getRes_name()%></span>
						</dd>
					</dt>
				</dl>
				<dl>
					<dt>
						<label for="res_phone">휴대폰번호</label>
							<dd>
								<span class="ui-input"><%=reserbean.getRes_phone()%></span>
							</dd>
					</dt>
				</dl>
				<dl>
					<dt>
						<label for="res_ppl">인원</label>
							<dd>
								<span class="ui-input"><%=reserbean.getRes_ppl()%></span>
							</dd>
					</dt>
               </dl>
				<dl>
					<dt>
						<label for="res_date">예약시간</label>
							<dd>
								<span class="ui-input"><%=reserbean.getRes_date()%></span>
							</dd>
						</dd>
					</dt>
               </dl>
			...
			<div class="btngroup">
				<input type="button" value="취소하기" onclick="button_event();" class="ui-btn btn-co1">
				<!-- <input type="button" value="수정하기" onclick="button_event2();" class="ui-btn btn-co1"> -->
				<%-- <button type="button" onclick="location.href='ResModifyAction.yu?res_name=<%=reserbean.getRes_name()%>'" class="ui-btn btn-co1">수정하기</button>
				<button type="button" onclick="location.href='ResCancelAction.yu?res_name=<%=reserbean.getRes_name()%>'" class="ui-btn btn-co1">취소하기</button> --%>
