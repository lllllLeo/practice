...
<meta name="subject" content="(주)쉐프마인드 오시는길" />
<meta name="copyright" content="(주)쉐프마인드" />
<meta name="title" content="(주)쉐프마인드 오시는길" />
<link rel="canonical" href="http://www.hankikor.com/page/sub1_4" />
<meta property="og:title"           content="(주)쉐프마인드 오시는길"/>
<meta property="og:site_name"       content="(주)쉐프마인드"/>
<meta property="og:type"            content="website"/>
<meta property="og:url"             content="http://www.hankikor.com/page/sub1_4"/>
<meta property="og:image"           content="http://www.hankikor.com/thum_img/ehompy0118/og_img/og_logo1519610629.jpg"/>
<meta name="twitter:card"           content="summary">
<meta name="twitter:title"          content="(주)쉐프마인드 오시는길">
...
<link rel="stylesheet" type="text/css" href="../img_up/shop_pds/ehompy0118/src_css_fram/pc.add.sub1_4.css" />
...
<script type="text/javascript" src="../img_up/_addon/_plugin/modernizr/modernizr.custom.media.query.js"></script>
	...
	var page_title = "(주)쉐프마인드 오시는길";
			...
			var ai_log_page_title = "(주)쉐프마인드 오시는길"; // 페이지 제목
			var ai_log_page_url = "/page/sub1_4"; // 페이지 url, 빈값 입력시 브라우져 url 자동 입력 입니다.
...
<div id="farmBoxLnb" class="lnb_183742_">
	...
	<ul class="dep1">
			...
			<a href="./sub3_1.yu" target="_self">Reservation</a>
					<div>			
					<ul class="dep2">							
							<li>
...
<div class="img_ratio_58223_">
			<img src="../thum_img/ehompy0118/farm/c2ea3444423dc65b76a879fedcb677e1_water__c1_w550_h188.jpg" alt="이미지명">
	</div>
</div>
<!-- ---------------  layout : 1칸 레이아웃 : 57429 --------------- -->



<div class="layout_57429_">
	<div>
		<div class="container_1">
<!-- ---------------   layout in : 지도 (직접입력) : 57430  --------------- -->


<div class="map_57430_">
	<iframe src="../../googlemap/hanki/API/google_map/google_map_addr.htm" width="200%" height="500" frameborder="1" scrolling="no" id="google_map_57430_" name="google_map_57430_"></iframe>
	<!-- <p>부산광역시 부산진구 동천로 136</p> -->
</div>

<!-- <script>
	// 타이틀, 주소, 가로, 세로, 줌
	// 주소를 입력하지 않으면 접속한 회원의 현재위치를 출력한다.
	google_map_addr("한끼맛있다","부산광역시 부산진구 동천로 136",600,400,16,'google_map_57430_');
</script> -->
</div>
	</div>
</div>
...
<span class="empty_line_57431_"></span>

<!-- ---------------  layout : 1칸 레이아웃 : 57432 --------------- -->



<div class="layout_57432_">
	<div>
		<div class="container_1">
<!-- ---------------   layout in : 타이틀 텍스트 : 57435  --------------- -->
<div   style='text-align:left;'  >


<div class="title_57435_ style_none">
	<p>한끼맛있다</p>
</div>
</div>
<!-- ---------------   layout in : 블릿형 리스트 : 57433  --------------- -->
<div   style='margin-top:15px;'  >

<div class="text_list_57433_">
	<ul>
		<li><span></span><p>주소 : 부산광역시 부산진구 동천로 136, 3층 (전포동)</p></li>															</ul>
</div>
</div>
<!-- ---------------   layout in : 블릿형 리스트 : 57434  --------------- -->
<div   style='text-align:left;'  >

<div class="text_list_57434_">
	<ul>
		<li><span></span><p>전화 : 1899-6731</p></li>		<li><span></span><p>팩스 : 051-803-0423</p></li>													</ul>
</div>
</div></div>
	</div>
</div>
...
<nav class="fnb_57720_">
	<ul>
					<li><a href="../shop_info/privacy.jsp">개인정보취급방침</a></li>
					<li><a href="../shop_info/agree.jsp">이용약관</a></li>
