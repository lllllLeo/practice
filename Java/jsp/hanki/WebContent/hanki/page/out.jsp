...
<title>(주)쉐프마인드 Salad/Drink</title>
...
<meta name="subject" content="(주)쉐프마인드 Salad/Drink" />
<meta name="copyright" content="(주)쉐프마인드" />
<meta name="title" content="(주)쉐프마인드 Salad/Drink" />
<link rel="canonical" href="http://www.hankikor.com/page/out" />
<meta property="og:title"           content="(주)쉐프마인드 Salad/Drink"/>
<meta property="og:site_name"       content="(주)쉐프마인드"/>
<meta property="og:type"            content="website"/>
<meta property="og:url"             content="http://www.hankikor.com/page/out"/>
<meta property="og:image"           content="http://www.hankikor.com/thum_img/ehompy0118/og_img/og_logo1519610629.jpg"/>
<meta name="twitter:card"           content="summary">
<meta name="twitter:title"          content="(주)쉐프마인드 Salad/Drink">
...
<link rel="stylesheet" type="text/css" href="../img_up/shop_pds/ehompy0118/src_css_fram/pc.add.out.css" />
...
<script type="text/javascript" src="../img_up/_addon/_plugin/modernizr/modernizr.custom.media.query.js"></script>
	...
	var page_title = "(주)쉐프마인드 Salad/Drink";
	</script>
				<script>
			// AI-LOG 기본 스크립트
			...
			var ai_log_page_title = "(주)쉐프마인드 Salad/Drink"; // 페이지 제목
			var ai_log_page_url = "/page/out"; // 페이지 url, 빈값 입력시 브라우져 url 자동 입력 입니다.
...
<!-- ---------------  layout : 1칸 레이아웃 : 184040 --------------- -->



<div class="layout_184040_">
	<div>
		<div class="container_1">
<!-- ---------------   layout in : 공백 : 57415  --------------- -->
<!-- 공백 -->
...
<span class="empty_line_57415_"></span>

<!-- ---------------   layout in : 이미지 (비율형) : 57745  --------------- -->
<div   style='text-align:center;'  ><!-- 이미지 (비율형) -->




<div class="img_ratio_57745_">
			<img src="../img_up/shop_pds/ehompy0118/farm/deu11519694230.jpg" alt="이미지명">
	</div>
</div>
<!-- ---------------   layout in : 이미지 (비율형) : 58588  --------------- -->
<div   style='text-align:center;'  ><!-- 이미지 (비율형) -->




<div class="img_ratio_58588_">
			<img src="../img_up/shop_pds/ehompy0118/farm/deu21519694195.jpg" alt="이미지명">
	</div>
</div>
<!-- ---------------   layout in : 이미지 (비율형) : 58587  --------------- -->
<div   style='margin-left:3px;text-align:center;'  ><!-- 이미지 (비율형) -->




<div class="img_ratio_58587_">
			<img src="../img_up/shop_pds/ehompy0118/farm/deu31519694285.jpg" alt="이미지명">
	</div>
</div></div>
	</div>
</div>
