...
<title>(주)쉐프마인드 Pizza Menu</title>
...
<meta name="subject" content="(주)쉐프마인드 Pizza Menu" />
<meta name="copyright" content="(주)쉐프마인드" />
<meta name="title" content="(주)쉐프마인드 Pizza Menu" />
<link rel="canonical" href="http://www.hankikor.com/page/sub2_5" />
<meta property="og:title"           content="(주)쉐프마인드 Pizza Menu"/>
<meta property="og:site_name"       content="(주)쉐프마인드"/>
<meta property="og:type"            content="website"/>
<meta property="og:url"             content="http://www.hankikor.com/page/sub2_5"/>
<meta property="og:image"           content="http://www.hankikor.com/thum_img/ehompy0118/og_img/og_logo1519610629.jpg"/>
<meta name="twitter:card"           content="summary">
<meta name="twitter:title"          content="(주)쉐프마인드 Pizza Menu">
...
<link rel="stylesheet" type="text/css" href="../img_up/shop_pds/ehompy0118/src_css_fram/pc.add.sub2_5.css" />
...
<script type="text/javascript" src="../img_up/_addon/_plugin/modernizr/modernizr.custom.media.query.js"></script>
	...
	var page_title = "(주)쉐프마인드 Pizza Menu";
	</script>
				<script>
			// AI-LOG 기본 스크립트
			...
			var ai_log_page_title = "(주)쉐프마인드 Pizza Menu"; // 페이지 제목
			var ai_log_page_url = "/page/sub2_5"; // 페이지 url, 빈값 입력시 브라우져 url 자동 입력 입니다.
...
<!-- ---------------  layout : 1칸 레이아웃 : 183785 --------------- -->



<div class="layout_183785_">
	<div>
		<div class="container_1">
<!-- ---------------   layout in : 공백 : 183786  --------------- -->
<!-- 공백 -->
...
<span class="empty_line_183786_"></span>

<!-- ---------------   layout in : 이미지 (비율형) : 183787  --------------- -->
<div   style='text-align:center;'  ><!-- 이미지 (비율형) -->




<div class="img_ratio_183787_">
			<img src="../img_up/shop_pds/ehompy0118/farm/pi-ja11519618915.jpg" alt="디너세트">
	</div>
</div>
<!-- ---------------   layout in : 이미지 (비율형) : 183789  --------------- -->
<div   style='text-align:center;'  ><!-- 이미지 (비율형) -->




<div class="img_ratio_183789_">
			<img src="../img_up/shop_pds/ehompy0118/farm/pi-ja21519618924.jpg" alt="디너세트">
	</div>
</div>
<!-- ---------------   layout in : 이미지 : 183788  --------------- -->
<!-- 이미지 -->




<div class="img_183788_">
			<img src="../img_up/shop_pds/ehompy0118/farm/pi-ja31519618898.jpg" alt="이미지명">
	</div>
</div>
	</div>
</div>
